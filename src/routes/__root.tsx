...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "Casal $" },
      ...
      { property: "og:title", content: "Finanças do Casal — Controle compartilhado" },
      {
      ...
      { name: "twitter:title", content: "Finanças do Casal — Controle compartilhado" },
      {
